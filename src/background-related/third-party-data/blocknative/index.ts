...
// import {
//   AssetDetails,
//   EthereumAssetBalanceChanges,
//   EthereumTransactionData,
// } from "./types";
// import { gweiToWei } from "../../lib/utils";
// import { ETHEREUM, ROPSTEN } from "../../constants/networks";
...
//             )
//             .filter(
//               ({ asset: { type: assetType } }: { asset: AssetDetails }) =>
//                 assetType === "ether"
//             )
//             .reduce(
//               (ethBalanceChangeDelta: any, { delta }: { delta: any }) =>
